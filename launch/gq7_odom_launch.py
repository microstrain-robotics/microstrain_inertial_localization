...
_GQ7_PARAMS_FILE = os.path.join(get_package_share_directory(_PACKAGE_NAME), 'config', 'gq7_odom', 'gq7.yml')
...
def generate_launch_description():
  ...
  arguments = [
    ...
    DeclareLaunchArgument('odom_frame_id',  default_value='odom',                description='The frame ID that you want to globally localize.'),
    ...
    DeclareLaunchArgument('filter_relative_position_frame',  default_value='2',                description='Relative position frame selector'),
    DeclareLaunchArgument('filter_relative_position_source', default_value='2',                description='Relataive position source selector'),
    DeclareLaunchArgument('filter_relative_position_ref',    default_value='[0.0, 0.0, 0.01]', description='Reference position. Units dictated by filter_relative_position_frame'),
